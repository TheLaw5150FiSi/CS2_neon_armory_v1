...
=======
    ...
    if (hasBind) {
        // Gib true zurück nur wenn der Bind nicht leer ist
        return cs2DefaultBinds[normalizedKey] && cs2DefaultBinds[normalizedKey] !== "";
    }
...
=======
    ...
    const descriptions = {
        ...
        "mwheeldown": "Mausrad runter - Nächste Waffe",
        "mouse1": "Linke Maustaste - Angriff / Schießen",
        "mouse2": "Rechte Maustaste - Sekundärangriff (Zielen / Alternative Granaten)",
        "mouse3": "Mittelklick - Spieler anpingen (Ping-Radar)",
        "mouse4": "Seitentaste 1 (Zurück) - Sprachchat (Voice)",
        "mouse5": "Seitentaste 2 (Vor) - Keine Standardbelegung"
    };
    
    return descriptions[normalizedKey] || descriptions[key] || `CS2 Standard-Bindung für "${key}"`;
>>>>>>> 38331c4ea550edcc13a34938b3a1f1ebfe97acf8
}
